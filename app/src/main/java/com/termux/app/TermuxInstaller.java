...
final class TermuxInstaller {
    ...
    static void setupBootstrapIfNeeded(final Activity activity, final Runnable whenDone, final MainActivity mainOptions) {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    ...
                    if (error != null) {
                        showBootstrapErrorDialog(activity, whenDone, Error.getErrorMarkdownString(error), mainOptions);
                        return;
                    }
...
//                }
    ...
    public static void showBootstrapErrorDialog(Activity activity, Runnable whenDone, String message, MainActivity mainOptions) {
            ...
            try {
                new AlertDialog.Builder(activity).setTitle(R.string.bootstrap_error_title).setMessage(R.string.bootstrap_error_body)
                    ...
                    .setPositiveButton(R.string.bootstrap_error_try_again, (dialog, which) -> {
                        ...
                        TermuxInstaller.setupBootstrapIfNeeded(activity, whenDone, mainOptions);
                    }).show();
